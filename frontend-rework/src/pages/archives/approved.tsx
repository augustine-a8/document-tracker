...
export function ApprovedArchiveRequests() {
  ...
  return (
    <div className="relative">
      <div className="h-20 flex flex-row items-center justify-between border-b border-b-gray-200 bg-white z-50">
        <div>
          <h2 className="text-lg font-semibold">Approved Archive Requests</h2>
          <p className="text-gray-500 font-medium">
            All requests for document in archives that have been approved
          </p>
        </div>
      </div>
          ...
          <table className="w-full mb-4">
            ...
            <tbody>
              {Archives.archives.map((document) => (
                <tr
                  key={document.id}
                  className="flex flex-row items-center font-medium px-4 h-12 border-b border-b-gray-100"
                >
                  ...
                  <td className="flex-1 font-normal"></td>
                  <td className="flex-1 font-normal"></td>
                </tr>
              ))}
            </tbody>
